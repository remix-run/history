...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.createHistory = _createMemoryHistory2['default'];

	var _createBrowserHistory2 = __webpack_require__(6);
	...
	var _NavigationTypes2 = __webpack_require__(1);

	var _NavigationTypes3 = _interopRequireDefault(_NavigationTypes2);

	exports.NavigationTypes = _NavigationTypes3['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NavigationTypes = __webpack_require__(1);

	var _NavigationTypes2 = _interopRequireDefault(_NavigationTypes);

	function createLocation(key) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function createHistory() {
	  ...
	  function pushState(state, path) {
	    transitionTo(_createLocation2['default'](createKey(), state, path, _NavigationTypes2['default'].PUSH));
	  }

	  function replaceState(state, path) {
	    transitionTo(_createLocation2['default'](createKey(), state, path, _NavigationTypes2['default'].REPLACE));
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getCurrentLocation(historyState) {
	  ...
	  return _createLocation2['default'](key, state, path);
	}
	...
	function finishTransition(location) {
	  ...
	  switch (location.navigationType) {
	    case _NavigationTypes2['default'].PUSH:
	      window.history.pushState(state, null, path);
	      break;
	    case _NavigationTypes2['default'].REPLACE:
	...
	function cancelTransition(location) {
	  if (location.navigationType === _NavigationTypes2['default'].POP) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function createHashHistory() {
	  ...
	  if (queryKey && typeof queryKey !== 'string') queryKey = DefaultQueryKey;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function createMemoryHistory() {
	  ...
	  entries = entries.map(function (entry) {
	    ...
	    if (typeof entry === 'string') return { path: entry, key: key };
	  ...
	  function getCurrentLocation() {
	    ...
	    var path = _entries$current.path;
